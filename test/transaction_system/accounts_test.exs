defmodule TransactionSystem.AccountsTest do
  ...
  describe "users" do
    ...
    test "create_user/1 with valid data creates a user" do
      valid_attrs = %{balance: 42, first_name: "some first_name", last_name: "some last_name"}
    ...
    test "update_user/2 with valid data updates the user" do
      user = user_fixture()
      update_attrs = %{balance: 43, first_name: "some updated first_name", last_name: "some updated last_name"}
